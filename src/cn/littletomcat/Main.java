package cn.littletomcat;

import cn.littletomcat.until.ClintRequestBean;
        ...
        try {
            ...
            while (true) {
                ...
                if (!(null==line)) {
                    ...
                    try {
                        classLoader.loadClass("cn.littletomcat.test.ExClass");
                    ...
                    Class<?> exClass = null;
                    try {
                        exClass = Class.forName("cn.littletomcat.test.ExClass");
